...
enum opt_code
{
  ...
  OPT_maccumulate_args = 1067,               /* -maccumulate-args */
  OPT_mbranch_cost_ = 1068,                  /* -mbranch-cost= */
  OPT_mcall_prologues = 1069,                /* -mcall-prologues */
  OPT_mdeb = 1070,                           /* -mdeb */
  OPT_mfract_convert_truncate = 1071,        /* -mfract-convert-truncate */
  OPT_mint8 = 1072,                          /* -mint8 */
  OPT_mlog_ = 1073,                          /* -mlog= */
  OPT_mmcu_ = 1074,                          /* -mmcu= */
  OPT_mn_flash_ = 1075,                      /* -mn-flash= */
  OPT_mno_interrupts = 1076,                 /* -mno-interrupts */
  OPT_mnon_bit_addressable_registers_mask_ = 1077,/* -mnon-bit-addressable-registers-mask= */
  OPT_morder1 = 1078,                        /* -morder1 */
  OPT_morder2 = 1079,                        /* -morder2 */
  OPT_mpmem_wrap_around = 1080,              /* -mpmem-wrap-around */
  OPT_mrelax = 1081,                         /* -mrelax */
  OPT_mrmw = 1082,                           /* -mrmw */
  OPT_mskip_bug = 1083,                      /* -mskip-bug */
  OPT_msp8 = 1084,                           /* -msp8 */
  OPT_mstrict_X = 1085,                      /* -mstrict-X */
  OPT_mtiny_stack = 1086,                    /* -mtiny-stack */
  OPT_n = 1087,                              /* -n */
  ...
  OPT_nodevicelib = 1092,                    /* -nodevicelib */
